...
#+LANGUAGE: es
#+DESCRIPTION: Práctica de Gretl, sesión 4 (A): primer contacto con el programa y con el dataset hprice2 de precios de vivienda en Boston; resumen, histograma y diagrama de caja.
#+OPTIONS: toc:nil
# +OPTIONS: author:nil
#+OPTIONS: date:nil
...
#+begin_src gretl :tangle ./guiones/S04-Prct-A-hprice2.inp :eval no :exports none :noweb yes
...
#+include: ./S04-Prct-A-hprice2/estadisticos.txt example
#+latex: }
...
#+begin_src gretl :tangle ./guiones/S04-Prct-A-hprice2.inp :eval no :exports none
freq price --plot="histograma_price.png"
#+end_src

#+BEGIN_EXPORT latex
\begin{figure}[H]
\centering
\includegraphics[width=0.62\textwidth]{./S04-Prct-A-hprice2/histograma_price.png}
\caption{Distribución de frecuencias de \texttt{price}.}
\end{figure}
#+END_EXPORT

#+BEGIN_EXPORT HTML
<figure style="text-align:center;">
    <img src="./S04-Prct-A-hprice2/histograma_price.png" style="max-width:62%; height:auto;"/>
    <figcaption>Distribución de frecuencias de <code>price</code>.</figcaption>
</figure>
#+END_EXPORT
...
#+begin_src gretl :tangle ./guiones/S04-Prct-A-hprice2.inp :eval no :exports none
boxplot price --output="boxplot_price.png"
#+end_src

#+BEGIN_EXPORT latex
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{./S04-Prct-A-hprice2/boxplot_price.png}
\caption{Diagrama de caja de \texttt{price}.}
\end{figure}
#+END_EXPORT

#+BEGIN_EXPORT HTML
<figure style="text-align:center;">
    <img src="./S04-Prct-A-hprice2/boxplot_price.png" style="max-width:45%; height:auto;"/>
    <figcaption>Diagrama de caja de <code>price</code>.</figcaption>
</figure>
#+END_EXPORT
