...
3. ¿Qué diferencia hay entre el vector generador $\boldsymbol{u}$ y el vector de residuos $\boldsymbol{\mathop{\widehat{e}}}$? ¿En qué caso particular, de los vistos hoy, coinciden exactamente?
