...
Compare cuánto sube $R^2$ y cuánto sube (o no) $\bar R^2$ al pasar de dos a tres regresores no constantes. Si =stratio= aportara muy poco, $\bar R^2$ podría incluso bajar al incluirla, mientras que $R^2$ jamás lo haría (por ejemplo, compare el ajuste con =rooms= + =proptax= (habitaciones más impuestos) con el ajuste si, además, añade =radial= (acceso a las autopistas)). 
