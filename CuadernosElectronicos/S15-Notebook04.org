...
Repetimos la simulación con un $\boldsymbol x$ mucho más disperso, manteniendo $n$ y $\sigma$ fijos, para comprobar visualmente la lectura de la fórmula $Var[\hat\beta_2\mid\boldsymbol X]=\sigma^2/(nS^2)$: a más dispersión en $x$, menor varianza de $\hat\beta_2$.
