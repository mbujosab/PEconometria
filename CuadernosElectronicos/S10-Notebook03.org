...
Repita ambas celdas con los ejemplos =fuerte= y =debil=. Observe cómo, al pasar de =fuerte= a =debil=, el ángulo $\theta$ se abre hacia $90^o$ y $R^2$ se acerca a $0$ —los “casos extremos” de la lección 8—, y compruebe en cada caso que $R^2=\cos^2\theta=\rho_{\boldsymbol{x}\boldsymbol{y}}^2$ sigue cumpliéndose.
