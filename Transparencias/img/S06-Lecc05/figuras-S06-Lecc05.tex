...
\date{\today}
\title{Código de las figuras del libro}
\begin{document}
...
\newpage
\section{Figuras con fuente tikz}
\label{sec:orgb6e6c2a}


\subsection{Correlación}
\label{sec:org1da60a2}

\begin{minted}[frame=lines,fontsize=\scriptsize,linenos=]{latex}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.5\textwidth]{./Correlacion.png}
\caption{Interpretación geométrica de la correlación como coseno de un ángulo}
\end{figure}
\subsection{Correlación 2}
\label{sec:org5939da5}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.5\textwidth]{./Correlacion2.png}
\caption{Interpretación geométrica de la correlación como coseno de un ángulo}
\end{figure}
\subsection{Varianza}
\label{sec:orgc4ed84b}
...
\begin{document}
  ...
  \begin{tikzpicture}
    ...
    \node[green!50!black,rotate=45,below left, fill=white,opacity=.9,text opacity=1] at (M) {\large$\mu_{\boldsymbol{y}}\cdot\boldsymbol{1}$};
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.5\textwidth]{./Varianza.png}
\caption{Interpretación geométrica de la varianza mediante el teorema de Pitágoras}
\end{figure}
\section{Trozos de código}
\label{sec:org3f46386}


Preámbulo para generar un fichero con únicamente una figura, y que use
la notación de \texttt{nacal}
\begin{minted}[frame=lines,fontsize=\scriptsize,linenos=]{tex}
\documentclass[border=10pt]{standalone} 
\usepackage[utf8]{inputenc}
\usepackage{nacal}
\end{minted}
...
proyecciones ortogonales usando la librería \href{http://www.bakoma-tex.com/doc/latex/tikz-3dplot/tikz-3dplot\_documentation.pdf}{tikz-3dplot}.
\begin{minted}[frame=lines,fontsize=\scriptsize,linenos=]{tex}
\usepackage{pgfplots}
\usepackage{tikz-3dplot}
...
\end{minted}
\section{Compilación}
\label{sec:org351b4d6}

\begin{center}
\begin{tabular}{l}
Para obtener los ficheros en emacs hay que teclear \texttt{C-c C-v t}\\
\end{tabular}
\end{center}

La conversión de pdf a png se realiza con \texttt{poppler-utils}
(especificamente con \texttt{pdftoppm}). Así que hay que instalar el programa
con \texttt{aptitude} (o programa similar).
...
Para generar los pngs teclear dentro del directorio \texttt{tex}
\begin{minted}[frame=lines,fontsize=\scriptsize,linenos=]{bash}
make pngs
\end{minted}

Si además se quiere generar los pdf en la carpeta \texttt{tex} (aunque no es
necesario) se puede teclear \texttt{make pdfs}

\begin{minted}[frame=lines,fontsize=\scriptsize,linenos=]{bash}
make pdfs
\end{minted}
\section{Ajustes de las figuras}
\label{sec:org0195506}
