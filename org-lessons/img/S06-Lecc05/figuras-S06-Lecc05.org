...
#+NAME: Correlacion
#+BEGIN_SRC latex :noweb no-export :tangle tex/Correlacion.tex :results discard :exports code
...
#+NAME: Correlacion2
#+BEGIN_SRC latex :noweb no-export :tangle tex/Correlacion2.tex :results discard :exports code
\documentclass[border=10pt]{standalone} 
\usepackage[utf8]{inputenc}
\usepackage{nacal}
\usepackage{pgfplots}
...
#+BEGIN_SRC latex :noweb no-export :tangle tex/Varianza.tex :results discard :exports code
\documentclass[border=10pt]{standalone} 
\usepackage[utf8]{inputenc}
\usepackage{nacal}
\usepackage{pgfplots}
