...
convert TrianguloContraste.png -gravity center -background white -extent 2600x TrianguloContraste_ancho.png
#+END_SRC
...
#+BEGIN_SRC bash :build yes
# Cada panel recortado a su contenido (x[559,1471], filas 130-1040: la misma ventana en los tres conserva la línea base común), hueco de 300 px entre paneles y fila de 3600 px; -gravity northwest antes de cada -crop porque en IM6 la gravedad persiste entre paréntesis
convert \( AngulosContraste1.png -gravity northwest -crop 912x910+559+130 +repage -gravity east -background white -splice 300x0 \) \( AngulosContraste2.png -gravity northwest -crop 912x910+559+130 +repage -gravity east -background white -splice 300x0 \) \( AngulosContraste3.png -gravity northwest -crop 912x910+559+130 +repage \) -background white -gravity center +append -extent 3600x AngulosContraste_fila.png
#+END_SRC
