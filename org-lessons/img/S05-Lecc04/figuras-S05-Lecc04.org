#+title: Código de las figuras de la lección 4
...
#+BEGIN_SRC  latex :noweb no-export :tangle tex/mediaAritmetica.tex :results discard :exports code :eval no
  <<Preambulo comun>>
...
[[file:./mediaAritmetica.png]]


** Media aritmética 1

#+NAME: MediaAritmetica1
#+BEGIN_SRC  latex :noweb no-export :tangle tex/MediaAritmetica1.tex :results discard :exports code :eval no
<<Preambulo comun>>
...
#+ATTR_ORG: :width 600
#+ATTR_LATEX: :width .5\textwidth :caption \caption{Interpretación geométrica de la media de un vector de \R[n]}
[[file:./MediaAritmetica1.png]]

** Media aritmética 2

#+NAME: MediaAritmetica2
#+BEGIN_SRC  latex :noweb no-export :tangle tex/MediaAritmetica2.tex :results discard :exports code :eval no
<<Preambulo comun>>
...
\begin{document}
  ...
  \begin{tikzpicture} [scale=3,
    ...
    \draw[vector, red!30!gray] (O) -- (P) node[anchor=south]{$\Vect{y}$};
    \draw[vector, color=blue!50!gray,thick]  (O) -- (Ymedia) node[anchor=west, xshift=-0.4mm, yshift=-1.4mm]{${\Vect{\Media{y}}}$};
...
#+ATTR_ORG: :width 600
#+ATTR_LATEX: :width .5\textwidth :caption \caption{Interpretación geométrica de la media de un vector de \R[n]}
[[file:./MediaAritmetica2.png]]

** Desviación Típica 0

#+NAME: DesviacionTipica0
#+BEGIN_SRC  latex :noweb no-export :tangle tex/DesviacionTipica0.tex :results discard :exports code :eval no
<<Preambulo comun>>
...
[[file:./DesviacionTipica0.png]]

** Desviación Típica 1

#+NAME: DesviacionTipica1
#+BEGIN_SRC  latex :noweb no-export :tangle tex/DesviacionTipica1.tex :results discard :exports code :eval no
<<Preambulo comun>>
...
\begin{document}
  ...
  \begin{tikzpicture} [scale=3,
    ...
    % draw a vector from O to P
    \draw[vector, red!30!gray] (O) -- (P) node[anchor=south west]{$\Vect{y}$};
    \draw[vector, color=blue!20!gray,thick]  (O) -- (Ymedia) node[anchor=south west]{${\Vect{\Media{y}}}$};
    \draw[vector, red!50!black,thick]  (O) --  (Pxz)node[anchor=south, xshift=0.55mm]{$\Vect{y}-\Vect{\Media{y}}$};
...
#+ATTR_ORG: :width 600
#+ATTR_LATEX: :width .5\textwidth :caption \caption{Interpretación geométrica de la desviación típìca de un vector de \R[n]}
[[file:./DesviacionTipica1.png]]

** Desviación Típica de dos datos
*** Ejemplo 1
 
#+NAME: DesviacionT1
#+BEGIN_SRC  latex :noweb no-export :tangle tex/DesviacionT1.tex :results discard :exports code :eval no
...
\begin{tikzpicture}
    ...
    % Dibujar el vector X
    \draw[-{Stealth[length=3mm, width=2mm]}, thick, green!50!black] (O) -- (X) node[above,fill=white,opacity=.9,text opacity=1]{$\boldsymbol{x}=(2,4,)$};
    
    % Dibujar el vector (-2,-2)
    \draw[-{Stealth[length=3mm, width=2mm]}, thick, blue!75!white] (O) -- (M) node[below right, sloped,fill=white,opacity=.9,text opacity=1]{$\mu\boldsymbol{1}$};
    
    % Dibujar la línea punteada entre (-2,-2) y (2,-6)
    \draw[dashed] (M) -- (X);
    
    % Dibujar el vector Uno
    \draw[-{Stealth[length=3mm, width=2mm]}, very thick, blue!55!black] (O) -- (U) node[below right,fill=white,opacity=.9,text opacity=1]{$\boldsymbol{1}=(1,1,)$};
...
#+ATTR_ORG: :width 600
#+ATTR_LATEX: :width .3\textwidth :caption \caption{Interpretación geométrica de la desviación típìca de un vector de \R[2]}
[[file:./DesviacionT1.png]]
...
#+NAME: DesviacionT2
#+BEGIN_SRC  latex :noweb no-export :tangle tex/DesviacionT2.tex :results discard :exports code :eval no
\documentclass[border=10pt]{standalone} 
\usepackage{tikz}
...
\begin{tikzpicture}
    ...
    % Dibujar el vector X
    \draw[-{Stealth[length=3mm, width=2mm]}, thick, green!50!black] (O) -- (X) node[above,fill=white,opacity=.9,text opacity=1]{$\boldsymbol{x}=(2,5,)$};
...
#+NAME: DesviacionT3
#+BEGIN_SRC  latex :noweb no-export :tangle tex/DesviacionT3.tex :results discard :exports code :eval no
\documentclass[border=10pt]{standalone} 
\usepackage{tikz}
\usetikzlibrary{calc, decorations.pathreplacing, arrows.meta} % Añadido arrows.meta
\usepackage{amsmath}
...
\begin{tikzpicture}
    ...
    % Dibujar el vector X
    \draw[-{Stealth[length=3mm, width=2mm]}, thick, green!50!black] (O) -- (X) node[below, sloped,fill=white,opacity=.9,text opacity=1]{$\boldsymbol{x}=(2,-6)$};
    
    % Dibujar el vector (-2,-2)
    %\node[green!50!black,align=center,fill=white,opacity=.9,text opacity=1] at (M) {$\mu\boldsymbol{1}=(-2,-2)$};
    \draw[-{Stealth[length=3mm, width=2mm]}, thick, blue!75!white] (O) -- (M) node[midway, above left, sloped,text opacity=1]{$\mu\boldsymbol{1}=(-2,-2)$};
...
#+ATTR_ORG: :width 250
#+ATTR_LATEX: :width .3\textwidth :caption \caption{Interpretación geométrica de la desviación típìca de un vector de \R[2]}
[[file:./DesviacionT3.png]]

** Suma de un vector constante

#+NAME: SumaCte
#+BEGIN_SRC  latex :noweb no-export :tangle tex/SumaCte.tex :results discard :exports code :eval no
<<Preambulo comun>>
...
#+NAME: SumaMediaNula
#+BEGIN_SRC  latex :noweb no-export :tangle tex/SumaMediaNula.tex :results discard :exports code :eval no
<<Preambulo comun>>
...
convert mediaAritmetica.png -gravity center -background white -extent 6000x mediaAritmetica_ancho.png
#+END_SRC
...
#+BEGIN_SRC bash :build yes
convert DesviacionT1.png DesviacionT2.png DesviacionT3.png -gravity center +append -background white -gravity center -extent 4800x${ALTURA} DesviacionT_fila_ancho.png
#+END_SRC
