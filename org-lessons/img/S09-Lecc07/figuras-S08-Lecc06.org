...
#+BEGIN_SRC latex :noweb no-export :tangle tex/OLS-regresoresNoPerpEconMedias.tex :results discard :exports code :eval no
  ...
  \begin{document}
    \begin{tikzpicture} [scale=3, tdplot_main_coords, axis/.style={-,gray,very thin},
      ...
      \draw[vector, blue!75!white]                                 (O) -- (a1) node[anchor=south]{${\hat\beta_0\Vect{1}}$};
      \draw[very thick,color=black,tdplot_rotated_coords,-stealth] (O) -- (bx) node[anchor=north east]{${\hat\beta_1\Vect{x}}$};
...
#+BEGIN_SRC latex :noweb no-export :tangle tex/OLS-regresoresNoPerpFconMedias.tex :results discard :exports code :eval no
  ...
  \begin{document}
    \begin{tikzpicture} [scale=3, tdplot_main_coords, axis/.style={-,gray,very thin},
      ...
      \draw[very thick,color=black,tdplot_rotated_coords,-stealth] (O) -- (bx) node[anchor=north west]{${\hat\beta_1\Vect{x}}$};
