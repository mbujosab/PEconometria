...
Un encargo concreto antes de la próxima sesión de laboratorio: /instalad Gretl/ en vuestro ordenador. Es gratuito, ocupa muy poco espacio y funciona en Windows, macOS y Linux. Lo podéis descargar en [[http://gretl.sourceforge.net][http://gretl.sourceforge.net]] para usarlo en vuestros ordenadores. Los puestos de las salas de ordenadores de la facultad también tienen Gretl instalado.
