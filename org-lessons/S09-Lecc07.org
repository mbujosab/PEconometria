...
#+CAPTION: Diagrama de dispersión clásico del ejemplo: los cinco puntos $(x_i,y_i)$ y la recta ajustada $\hat y=2+3x$. Las líneas discontinuas son los residuos $\hat e_i=u_i$. [[https://mybinder.org/v2/gh/mbujosab/PEconometria/gh-pages?labpath=CuadernosElectronicos/S09-Notebook02.ipynb][Versión interactiva]] (cuaderno 2, parte 3).
