...
#+attr_ipynb: (slideshow . ((slide_type . fragment)))
/Versión interactiva/: [[https://mybinder.org/v2/gh/mbujosab/PEconometria/gh-pages?labpath=CuadernosElectronicos/S09-Notebook02.ipynb][cuaderno 2 en MyBinder]], parte 2 (los tres vectores en desviaciones, en $\mathcal{L}(\boldsymbol{1})^\perp$).
...
En el mismo espíritu que en el laboratorio ([[https://mbujosab.github.io/PEconometria/Practicas-pdf/S07-Prct-B-verificacion-geometrica.pdf#page=3][actividad 3]] ([[https://mbujosab.github.io/PEconometria/Practicas-html/S07-Prct-B-verificacion-geometrica.html#relacion-conocida][html]]) sobre $\boldsymbol{y}=2+3\boldsymbol{x}+\boldsymbol{u}$), pero con una muestra pequeña ($n=5$) calculable a mano:
