...
\]
Y como $\quad c^2 = \|\boldsymbol{a}-\boldsymbol{b}\|^2 = 2 - 2\,\langle\boldsymbol{a}\,,\boldsymbol{b}\rangle,\quad$
tenemos que:
\(
\quad
\cos\theta = x = \langle\boldsymbol{a}\,,\boldsymbol{b}\rangle.
\)
...
\(
\quad
\boxed{\;\cos\theta = \dfrac{\langle\boldsymbol{a}\,,\boldsymbol{b}\rangle}{\|\boldsymbol{a}\|\,\|\boldsymbol{b}\|}\;}
\)
...
- /La ortogonalidad es una noción central del curso/: en la regresión, los residuos (la diferencia entre los datos originales y el ajuste del modelo) serán ortogonales a los /regresores/ (los vectores que se combinan para construir el ajuste; los definiremos con precisión al llegar a la regresión).
