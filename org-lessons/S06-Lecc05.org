...
#+attr_ipynb: (slideshow . ((slide_type . fragment)))
/Versión interactiva/: [[https://mybinder.org/v2/gh/mbujosab/PEconometria/gh-pages?labpath=CuadernosElectronicos/S05-Notebook01.ipynb][cuaderno 1 en MyBinder]], parte 2 (el ángulo entre los vectores en desviaciones, rotable).
