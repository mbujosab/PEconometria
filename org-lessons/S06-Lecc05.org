...
2) Es el teorema de Pitágoras despejado, usando que $\Vert\mu_{\boldsymbol{x}}\boldsymbol{1}\Vert^2=\mu_{\boldsymbol{x}}^2$ porque $\Vert\boldsymbol{1}\Vert=1$.
