...
\[
\boxed{\;\sigma_{\boldsymbol{y}}^2 \;=\; \|\boldsymbol{y}\|_s^2 - \mu_{\boldsymbol{y}}^2 \;=\; \frac{1}{n}\sum_{i=1}^n x_i^2 \,-\, \mu_{\boldsymbol{y}}^2 \;=\;
