...
Verifiquémoslo con dos de los ejemplos numéricos de la lección 4. Tomamos $\boldsymbol{x}=(2,4)$ (con $\mu_{\boldsymbol{x}}=3$, en deviaciones $(-1,1)$ y $\sigma_{\boldsymbol{x}}=1$) y $\boldsymbol{z}=(2,-6)$ (con $\mu_{\boldsymbol{z}}=-2$, en desviaciones $(4,-4)$ y $\sigma_{\boldsymbol{z}}=4$). La covarianza es
\[
