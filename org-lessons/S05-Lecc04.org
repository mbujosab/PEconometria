...
#+attr_ipynb: (slideshow . ((slide_type . fragment)))
/Versión interactiva en $\mathbb{R}^3$/: [[https://mybinder.org/v2/gh/mbujosab/PEconometria/gh-pages?labpath=CuadernosElectronicos/S05-Notebook01.ipynb][cuaderno 1 en MyBinder]] (rotar la figura, cambiar los vectores).
