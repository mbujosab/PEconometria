...
#+attr_ipynb: (slideshow . ((slide_type . fragment)))
/Versión interactiva/: [[https://mybinder.org/v2/gh/mbujosab/PEconometria/gh-pages?labpath=CuadernosElectronicos/S10-Notebook03.ipynb][cuaderno 3 en MyBinder]], parte 1 (el triángulo, rotable, dentro de $\mathcal{L}(\boldsymbol{1})^\perp$).
