...
#+attr_ipynb: (slideshow . ((slide_type . fragment)))
Para cada $i=1,\ldots,n$: \(\quad Y_i=\beta_1\,\mathit1+\beta_2X_i+U_i,\)

con los tres supuestos de la lección 9, condicionando ahora en $\boldsymbol X$ (p. ej. $Var[U_i\mid\boldsymbol X]=\sigma^2\,\mathit1$).
